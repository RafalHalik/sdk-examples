...
// void *vglite_heap_base    __aligned(64)= &contiguous_mem;
// uint32_t vglite_heap_size __aligned(64)= MAX_CONTIGUOUS_SIZE;
...
//     irq_connect_dynamic(GPU2D_IRQn, 3, GPU2D_IRQHandler, NULL, 0);

...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_VDB_SIZE, 50);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIPI_DSI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 151072);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HIMAX_HX8394_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_IMX_MIPI_DSI_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_VEETHREE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_MEM_POOL_SIZE, 49152);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_BUFFER_ALLOC_STATIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_SHELL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_LVGL_VEETHREE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_USB_HOST_VEETHREE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_VG_LITE_VEETHREE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_VG_LITE_VEETHREE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MIMXRT1160_EVK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_MIMXRT1160_EVK_MIMXRT1166_CM7, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QUALIFIERS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_RK055HDMIPI4MA0, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HX8394, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_MCUX_USE_DTCM_FOR_DMA_DESCRIPTORS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIPI_DSI_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIPI_DSI_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIPI_DSI_INIT_PRIORITY, 86);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MIPI_DSI_MCUX, 1);

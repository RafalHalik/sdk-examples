...
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_start;
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_stop;
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_suspend;
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_resume;
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_request_channel;
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_release_channel;
extern __weak ALIAS_OF(no_handler) void * const z_impl_dma_chan_filter;

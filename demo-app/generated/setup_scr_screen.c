...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_bar_1, 278, 146);
	...
	lv_obj_set_pos(ui->screen_bar_2, 278, 38);
	...
	lv_obj_set_pos(ui->screen_bar_3, 278, 1173);
	...
	lv_obj_set_pos(ui->screen_bar_4, 278, 1063);
	...
	lv_img_set_src(ui->screen_img_2, &_centreBit_alpha_210x200);
	lv_img_set_pivot(ui->screen_img_2, 50,50);
	lv_img_set_angle(ui->screen_img_2, 900);
	lv_obj_set_pos(ui->screen_img_2, 367, 530);
	lv_obj_set_size(ui->screen_img_2, 210, 200);

	//Write style for screen_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_img_recolor_opa(ui->screen_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_img_opa(ui->screen_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_img_2, 200, LV_PART_MAIN|LV_STATE_DEFAULT);
